> Historical planning document. Current implementation and verified follow-ups are documented in [Core architecture](../CORE_PAYMENT_ARCHITECTURE.md) and [Installer / multi-wallet checkpoint](../INSTALLER_MULTI_WALLET_PROGRESS.md). Unchecked items below are not a statement of current runtime behavior.
