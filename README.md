...
| `admin/views/`, `assets/admin.css` | Přepracováno | Sdílený široký a responzivní světlý design systém dashboardu, peněženky, obchodů, faktur, webhooků a URL faktur; primární akce používají zelený akcent z veřejné prezentace a provozní stavy vlastní sémantické barvy. |
