...
final class ElectrumCliWalletProvisioner implements StoreWalletProvisioner
{
    ...
    public function __construct(
        ...
        $resolvedDataDirectory = realpath($electrumDataDirectory);
        $resolvedWalletDirectory = realpath($walletDirectory);
        ...
        $this->electrumDataDirectory = $resolvedDataDirectory;
        $this->walletDirectory = $resolvedWalletDirectory;
    ...
    public function provision(string $storeId): string
    {
        ...
        $walletPath = $this->walletDirectory . DIRECTORY_SEPARATOR . $storeId . '_wallet';
        ...
        if (
            ...
            || is_link($walletPath)
            || dirname($resolvedWallet) !== $this->walletDirectory
        ) {
