...
-- Force fresh observations; the persisted Settled/Processing states retain payment evidence.
UPDATE invoices SET confirmed_balance_sats = 0, mempool_delta_sats = 0,
    payment_processing_token = NULL, payment_processing_until = NULL, next_check_at = NULL;
